...
namespace _04.ciclos
{
    class Program
    {
        ...
        static void Menu(){
            ...
            Console.WriteLine("[2] Numeros del 100 al 1 con cilco do while \n");
            Console.WriteLine("[3] Numeros del 50 al 200 con cliclo for \n");
            Console.WriteLine("[4] Numeros del 2 al 100 solo los pares con cliclo for \n");
            Console.WriteLine("[5] Numeros del 99 al 1 solo los impares con cliclo for \n");
